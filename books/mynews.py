...
class mynews(BaseFeedBook):
    ...
    feeds = [
        ...
        (u'The News Lens 關鍵評論網', 'https://feeds.feedburner.com/TheNewsLens?format=xml'),
        (u'經濟日報', 'https://money.udn.com/rssfeed/news/'),
        (u'BBC Chinese - 主頁', 'http://feeds.bbci.co.uk/zhongwen/trad/rss.xml'),
        ...
        (u'Anue鉅亨', 'https://news.cnyes.com/rss/v1/news/category/headline'),
