...
class gvm(BaseFeedBook):
    ...
    keep_only_tags = [
        dict(name='div', class_='article-block'),
    ]
    remove_classes = ['list','newsletter','article-review','article-features','article-extended','keyWord article-keyword text-center','article-author','extendedReading','floating-share','article-share article-share__bottom','article-publication']
