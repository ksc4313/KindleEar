...
class bnext(BaseFeedBook):
    ...
    remove_classes = ['article_recommend_title','article_recommends','article_tags','mobile_share_block_sty02','add_bnext_line_block','mobile_share_block_sty02','mobile_share_block_sty01','rt_hot_news','fb-comments fb_iframe_widget fb_iframe_widget_fluid_desktop','cate_box','sp_author collapse show']
    # 指定要提取的包含文章列表的主题页面链接
