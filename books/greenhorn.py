...
# 继承基类BaseFeedBook
class greenhorn(BaseFeedBook):
    # 设定生成电子书的元数据
    title = u'greenhorn' # 设定标题
    __author__ = u'greenhorn' # 设定作者
    description = u'greenhorn' # 设定简介
    language = 'zh-TW' # 设定语言
    deliver_times=[2,10,18] #2:00,10:00,18:00
    oldest_article=28800 #8*60*60
    fulltext_by_readability = False
    keep_only_tags = [
        dict(name='div', class_='post hentry uncustomized-post-template'),
    ]
    remove_classes = ['post-labels']
    # 指定要提取的包含文章列表的主题页面链接
